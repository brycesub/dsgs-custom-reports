...
- All rows kept; split into one sheet per fiscal year (July–June) labeled `FY {year}`. Tab order is current FY (left-most and active), then future years ascending, then past years descending.
